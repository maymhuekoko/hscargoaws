    ...
    <div class="tab-content br-n pn">
                ...
                <div class="row mb-3">
                    <div class="col-md-3">
                        ...
                        <select class="form-control rounded border border-primary" aria-label=".form-select-lg example" name="adv_route" id="adv_route">
                            <option data-from="{{$from_city_id}}" data-to="{{$to_city_id}}" selected>{{$route}}</option>
                    ...
                    <div class="col-md-2">
                        ...
                        <input type="time" class="form-control rounded border border-primary mb-2" name="way_time" id="way_time" value="{{$start_time}}">
                    </div>
                    <div class="col-md-2">
                        <label>End Time</label>
                        <input type="time" class="form-control rounded border border-primary mb-2" name="end_time" id="end_time" value="{{$end_time}}">
                    </div>
        ...
        <div id="navpills-2" class="tab-pane">
            ...
            <div class="card-body">
                ...
                <h3 class="mt-5">{{$time->route_name}}</h3>
                <div class="row mt-3">
